...
public class AccessHistoryDAO extends DAO {
    ...
    public List<Object[]> searchByTime(String timeString) {
        ...
        try {
            // "gg:pp" format is expected (HH:mm)
            // SQL Server CONVERT(VARCHAR(5), timeStamp, 108) returns HH:mm
            ...
            while(rs.next()) {
                // Formatting duration from seconds to HH:mm:ss
