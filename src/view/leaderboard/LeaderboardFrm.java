...
public class LeaderboardFrm extends JPanel {
    ...
    private JPanel createOverviewPanel() {
        ...
        dao.LeaderboardDAO dao = new dao.LeaderboardDAO();
        // Giả lập lấy thông tin tài khoản đang đăng nhập hiện tại
        ...
        btnViewRank.setVisible(false); // Hide standard detail btn to match mockup
