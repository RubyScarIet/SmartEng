...
import view.admin.RoundedBorder; // Reusing the same rounded border class
...
public class LearnerHomeFrm extends JFrame {
    ...
    public LearnerHomeFrm(model.User user) {
        ...
        // Main Wrapper to give rounded look
    ...
    private void switchTab(String tabName) {
        ...
        switch (tabName) {
            case "Study": viewPanel = new StudyFrm(); break;
            case "Alphabet": viewPanel = new AlphabetFrm(); break;
